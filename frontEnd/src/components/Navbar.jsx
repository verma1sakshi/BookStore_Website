...
function Navbar() {
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 fixed top-0 left-0 right-0 z-50 ${sticky?"sticky-navbar shadow-md bg-base-200  dark:bg-slate-800 dark:text-white duration-300 transition-all ease-in-out":"" }`}>
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className=" mt-4  text-3xl md:text-4xl font-bold cursor-pointer hover:underline" href="/">BookStore</a>
          </div>
...
{/* ====login logout condition  */}
{
  authUser?<Logout/> :
            ...
            <div className="">
              <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800  duration 300ms cursor-pointer dark:bg-white dark:text-slate-900 " onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
              <Login/>
            </div>
}
          </div>
